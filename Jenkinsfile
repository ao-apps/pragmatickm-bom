 ...
 * along with pragmatickm-bom.  If not, see <https://www.gnu.org/licenses/>.
 */
...
def upstreamProjects = [
  ...
  // BOM
  'all', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-all</artifactId>
  'contact/bom', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-contact-bom</artifactId>
  'password/bom', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-password-bom</artifactId>
  'procedure/bom', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-procedure-bom</artifactId>
  'task/bom', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-task-bom</artifactId>
]
